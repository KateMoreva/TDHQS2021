...
//    data class TagInfo(val id: Long, val name:String, val address: String, val layer_name: String,
//            val ownerId: Long)
//    class TagsAdapter() :
...
//                var layer_name = ""
//                try {
//                    layer_name = database.layerDao().getById(database
//                        .placeLayerDao().getByPlaceId(it.id)[0].layerId).name
//                } catch (ex: Exception) {}
...
//                deleteButton = itemView.findViewById(R.iеашчd.tag_delete)
//            }
//        }
//
...
//        AlertDialog.Builder(this).setMessage(getText(R.string.tag_remove_alert).toString()
//            .replace("%s", tag.name))
//            .setPositiveButton(R.string.remove, { dialogInterface: DialogInterface, _: Int -> delete_tag(tag)})
//            .setNegativeButton(R.string.cancel, { dialogInterface: DialogInterface, i: Int -> dialogInterface.cancel()}).create().show()
//    }
//
